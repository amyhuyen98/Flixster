package com.amyhuyen.flixster.models;
...
import com.amyhuyen.flixster.MovieDetailsActivity;
...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (isPortrait){
            imageUrl = config.getImgUrl(config.getPosterSize(), movie.getPosterPath());
        } else{
            // load the backdrop image
            imageUrl = config.getImgUrl(config.getBackdropSize(), movie.getBackdropPath());
        }
